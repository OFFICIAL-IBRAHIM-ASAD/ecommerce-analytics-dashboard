  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const [revenueRes, categoryRes, productsRes, ordersRes] = await Promise.all([
          ...
          fetch('http://127.0.0.1:8000/api/orders/recent')
        ])
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8 font-sans text-gray-800">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {/* Header */}
        <header>
          <h1 className="text-3xl font-bold text-gray-900 tracking-tight">E-Commerce Analytics Dashboard</h1>
